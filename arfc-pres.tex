...
\gls{ULOFA} - pump trip leading to loss of flow through core, sodium boiling, core meltdown and slumping, large reactivity addition \cite{raghupathy_source_2017}
\begin{itemize}
...
\begin{enumerate}
    ...
    \item Obtain model for hydrogen desorption with temperature
...
\begin{enumerate}
    \item Run accident scenario core simulation with hydrogen desorption
          model
...
Control rod position varies throughout operation
