...
Need for a control rod with a longer lifetime
\begin{itemize}
...
over a \bc control rod.
\begin{itemize}
    \item General material characteristics (nuclear properties)
    \item \gls{JSFR} performance metrics
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \begin{itemize}
      \item Inherent safety is a characteristic of reactor, not control rod
  \end{itemize}
  \item Energy in cross section values
  \item 
\end{itemize}
\end{frame}
